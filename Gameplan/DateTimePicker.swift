...
@objc public class DateTimePicker: UIView {
    ...
    public var highlightColor = UIColor(red: 0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1) {
        didSet {
    ...
    public var dateFormat = "MM/dd/YYYY HH:mm" {
        didSet {
            resetDateTitle()
        }
    }
    ...
    @objc open class func show(selected: Date? = nil, minimumDate: Date? = nil, maximumDate: Date? = nil, timeInterval: Int = 1) -> DateTimePicker {
        ...
        let defaultDateBound: TimeInterval = 3600 * 24 // 20 years ago-from now
